...
Descrição---------: Ponto de entrada para tratamento do PIS com Alíquota Diferenciada.
Parametros--------: PARAMIXB[1] -> C -> Item atual do processo
                    PARAMIXB[2] -> N -> Alíquota do PIS de Apuração
Retorno-----------: _cUsaAlq, _nAliq -> A -> Utiliza (S/N), o Valor do PIS Retornado pela Função. Alíquota do PIS de Apuração.
===============================================================================================================================
*/
